...

{
    ...
    //     /* Columns we need */
    //     $table->include = ['icon', 'name', 'protocol', 'api_url'];
    //     $table->mainColumn = 'name';

    //     /* Default sort options */
    //     $table->sortBy = $table->sortBy ?: 'name';
    //     $table->noSort = ['icon', 'protocol', 'api_url'];
    ...
    //     $form->add(new \IPS\Helpers\Form\Text('aXenServerList_admin_table_mods_api_current_players', $item ? $item['api_current_players'] : '', true, [], null, null, null, 'aXenServerList_admin_table_mods_api_current_players'));
    //     $form->add(new \IPS\Helpers\Form\Text('aXenServerList_admin_table_mods_api_max_players', $item ? $item['api_max_players'] : '', true, [], null, null, null, 'aXenServerList_admin_table_mods_api_max_players'));
    ...
    //     $form->add(new \IPS\Helpers\Form\Select('aXenServerList_admin_table_mods_protocol', $item ? $item['protocol'] : '', true, ['options' => [
